package com.zuiyou.jd.shopcar.view;
...
import com.zuiyou.jd.shopcar.adapter.ShopcartAdapter;
import com.zuiyou.jd.shopcar.bean.GoodsInfo;
import com.zuiyou.jd.shopcar.bean.StoreInfo;
...
public class FragShoppingCar extends Fragment implements
        ShopcartAdapter.CheckInterface,ShopcartAdapter.ModifyCountInterface, ShopcartAdapter.GroupEdtorListener
{
    @BindView(R.id.back)
    ImageView back;
    @BindView(R.id.title)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.frag_shopcar, null);
...
//   因为是在Fragment中所以没有此生命周期方法，
//   但是经过测试发现并没有实际影响，所以注释也没关系
//    @Override
...
//    }
    ...
    private void initDatas() {
        for (int i = 0; i < 3; i++) {
            groups.add(new StoreInfo(i + "", "京东商家" + (i + 1) + "号店"));
